  ...
  class RDFDatastream < ActiveFedora::Datastream
    ...
    class << self
      ...
      def resource_class(klass=nil)
        ...
        @resource_class ||= (klass || ActiveTriples::Resource)
      end
    end
    ...
    def resource
      @resource ||= begin
                      klass = Class.new(self.class.resource_class)
                      klass.include Rdf::Persistence
                      klass.properties = klass.properties.merge(self.class.properties)
                      klass.accepts_nested_attributes_for(*nested_attributes3_options.keys) unless nested_attributes_options.blank?
